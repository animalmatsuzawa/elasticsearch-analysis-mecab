...
public class MecabIterationMarkCharFilterFactory extends AbstractCharFilterFactory implements MultiTermAwareComponent {

    private final boolean normalizeKanji;
    private final boolean normalizeKana;

    public MecabIterationMarkCharFilterFactory(IndexSettings indexSettings, Environment env, String name, Settings settings) {
